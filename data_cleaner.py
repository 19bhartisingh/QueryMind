"""
data_cleaner.py — Data Cleaning & Preprocessing Engine for QueryMind
...
def build_cleaning_pdf(
    ...
    try:
        ...
        def on_page(canvas, doc):
            ...
            canvas.drawString(MARGIN, 7*mm, f"QueryMind Data Cleaning Report · {date_str}")
        ...
        import io as _io
        txt = f"QueryMind Data Cleaning Report\n{'='*40}\n"
