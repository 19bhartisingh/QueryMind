...
const sqlDatabaseProjectTaskProvider_1 = require("../../src/tasks/sqlDatabaseProjectTaskProvider");
suite("Sql Database Projects Task Provider", function () {
    let sandbox;
    let taskProvider;
    ...
    test("Should create build and buildWithCodeAnalysis tasks for .sqlproj file with correct properties for SDK style project", async function () {
        // Define mock .sqlproj file URIs for testing
    ...
    test("Should not create any tasks when no .sqlproj files are present in the workspace", async function () {
        // Define mock .sqlproj file URIs for testing
    ...
    test("Should create build and buildWithCodeAnalysis tasks for multiple .sqlproj files with correct properties", async function () {
        // Define mock .sqlproj file URIs for testing
    ...
    test("Should create tasks with correct build arguments for legacy-style project", async function () {
        // Define mock .sqlproj file URIs for testing
        stubWorkspaceAndFiles([sqlProjUris[0]]);
        // Stub the project as SDK style
