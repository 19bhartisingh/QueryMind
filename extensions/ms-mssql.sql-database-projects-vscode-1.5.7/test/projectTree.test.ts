...
suite("Project Tree tests", function (): void {
    ...
    test("Should build tree from Project file correctly", function (): void {
        ...
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry(path.join("someFolder", "bNestedTest.sql"), EntryType.File),
        );
        proj.folders.push(
            proj.createFileProjectEntry(path.join("someFolder", "bNestedFolder"), EntryType.Folder),
        );
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry(path.join("someFolder", "aNestedTest.sql"), EntryType.File),
        );
        proj.folders.push(
            proj.createFileProjectEntry(path.join("someFolder", "aNestedFolder"), EntryType.Folder),
        );
    ...
    test("Should be able to parse windows relative path as platform safe path", function (): void {
        ...
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry(
                "someFolder1\\MyNestedFolder1\\MyFile1.sql",
                EntryType.File,
            ),
        );
        proj.folders.push(
            proj.createFileProjectEntry("someFolder1\\MyNestedFolder2", EntryType.Folder),
        );
        proj.folders.push(proj.createFileProjectEntry("someFolder1", EntryType.Folder));
        proj.folders.push(
            proj.createFileProjectEntry("someFolder1\\MyNestedFolder1", EntryType.Folder),
        );
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry("someFolder1\\MyFile2.sql", EntryType.File),
        );
    ...
    test("Should be able to parse and include relative paths outside project folder", function (): void {
        ...
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry("..\\..\\someFolder2\\MyFile2.sql", EntryType.File),
        );
        proj.sqlObjectScripts.push(
            proj.createFileProjectEntry("..\\..\\someFolder3", EntryType.Folder),
