...
[![The MIT License](https://img.shields.io/badge/license-MIT-orange.svg)](https://github.com/SvenBecker/vscode-pytorch/blob/master/LICENSE.md)
[![GitHub](https://img.shields.io/badge/github-v1.0.2-blue.svg)](https://github.com/SvenBecker/vscode-pytorch/releases)
...
All of the past as well as the upcoming changes can further be viewed at [Changelog](https://github.com/SvenBecker/vscode-pytorch/blob/master/CHANGELOG.md).
...
and there is still so much to do, please take a look at [Contributing](https://github.com/SvenBecker/vscode-pytorch/blob/master/CONTRIBUTING.md).
